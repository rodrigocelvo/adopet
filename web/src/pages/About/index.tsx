    ...
    <>
      <Container>
        <Content>
          ...
          <Description>
            O Programa Adote Petz é a conexão que faltava entre você e o seu melhor amigo: através
            do cadastro e atuação de ONGs/protetores independentes e diversas instituições
            ...
            instituições parceiras em todo o Brasil. Funciona assim: o programa Adote Petz cadastra
            ONGs/protetores independentes para que cães e gatos tenham uma chance de encontrar um
            lar. A Petz disponibiliza espaços permanentes dedicados à adoção no centro de suas
            ...
            ONGs/protetores. A vantagem dessa união entre a Petz e as ONGs/protetores é que os
